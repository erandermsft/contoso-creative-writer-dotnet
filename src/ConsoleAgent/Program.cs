...
//ChatCompletionAgent GetInfluencerAgent()
//{
...
//            {"article", File.ReadAllText("./agents/influencer/article.txt")   }
//            }
//        };
//    return influencerAgent;
//}
//ChatCompletionAgent GetWriterAgent()
//{
...
//    return influencerAgent;
//}
//ChatCompletionAgent GetResearcherAgent()
//{
//    string researcherPrompty = File.ReadAllText("./agents/researcher/researcher.prompty");
//    var researcherKernel = kernel.Clone();
//    researcherKernel.CreateFunctionFromMethod<ResearcherAgent>("GetResearcherAgent");
//    // Convert to a prompt template config
//    PromptTemplateConfig writerTemplateConfig = KernelFunctionPrompty.ToPromptTemplateConfig(researcherPrompty);
